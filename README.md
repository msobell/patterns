...
| [`fastapi-dashboard.md`](fastapi-dashboard.md) | Local web dashboard — FastAPI serving a thin JSON API + Jinja HTML shell, vanilla-JS fetch, Chart.js, and a dark CSS-variable design system; no frontend build step |
